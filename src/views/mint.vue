  ...
  <div class="wrap mint-wrap">
    ...
    <div class="content mint-content">
      ...
      <MintBar
        ...
        :has-other-token="formData.address ? true : false"
...
export default class Lend extends Vue {
  ...
  calculateResult() {
    ...
    tokenAmount = tokenAmount > 0 ? tokenAmount.toFixed(this.otherToken.decimals) : 0;
    usddAmount = usddAmount > 0 ? usddAmount.toFixed(this.usddToken.decimals) : 0;
    ...
    this.tokenShowValue = pladgeAmount.toSignificant();
